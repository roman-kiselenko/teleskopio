...
import { ConfigLink } from './links/Config';
import { NetworkLink } from './links/Network';
import { StorageLink } from './links/Storage';
import { AccessLink } from './links/Access';
      ...
      >
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent sideOffset={0}>settings</TooltipContent>
          </Tooltip>
        </TooltipProvider>
      </NavLink>
    </div>
