    ...
    <div className="flex flex-col w-38 border-r border-gray-300">
        <button className="relative text-sm focus:outline-none group">
            ...
            <div className="absolute z-10 flex-col items-start hidden w-full pb-1 bg-white shadow-lg group-focus:flex">
                <a className="w-full px-4 py-1 text-left hover:bg-blue-300" href="#">default</a>
                <a className="w-full px-4 py-1 text-left hover:bg-blue-300" href="#">kube-system</a>
                <a className="w-full px-4 py-1 text-left hover:bg-blue-300" href="#">core-dns</a>
            </div>
        </button>
